...
if __name__ == "__main__":
    ...
    for test in tests:
        try:
            ...
            print(f"      Hint: Complete Exercises 1 and 2 (and Exercise 13 in Part 1) first.")
            failed += 1
    ...
    if failed == 0:
        ...
        print("\nSome tests failed. Make sure Exercises 1 and 2 (and Exercise 13 in Part 1) are complete.")
