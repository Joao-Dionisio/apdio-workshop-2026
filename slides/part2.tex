...
\begin{tikzpicture}[
  ...
  % Subtour 1 (left triangle) -- red
  \node[city] (a1) at (0, 1.2)  {};
  \node[city] (a2) at (0.9, 0)  {};
  \node[city] (a3) at (-0.9, 0) {};
  \draw[subtour, red!70!black] (a1) -- (a2) -- (a3) -- (a1);

  % Subtour 2 (right triangle) -- green
  \node[city] (b1) at (2.8, 1.2) {};
  \node[city] (b2) at (3.7, 0)   {};
  \node[city] (b3) at (1.9, 0)   {};
  \draw[subtour, green!60!black] (b1) -- (b2) -- (b3) -- (b1);
  ...
  \node[draw, dashed, green!60!black, rounded corners, fit=(b1)(b2)(b3),
        inner sep=5pt, label={[font=\scriptsize,green!60!black]below:$S_2$}] {};

  % No connection between the two groups
  \node[font=\small\bfseries, red!60!black] at (1.4, -1.3)
    {Subtour violation!};
  \node[font=\scriptsize] at (1.4, -1.8)
