...
\begin{itemize}
  \item Set a time limit and observe the effect on a hard instance.
  \item Compare default vs.\ \texttt{FEASIBILITY} emphasis.
  \item Use \texttt{limits/gap} to accept near-optimal solutions.
  \item Load a model from an \texttt{.lp}/\texttt{.mps} file and tune parameters.
\end{itemize}
\end{block}
\begin{itemize}
...
% ---------------------------------------------------------
% Frame 14: Nonlinear Blending (Pooling Problem)
% ---------------------------------------------------------
...
% Frame 15: Exercise 5
% ---------------------------------------------------------
\begin{frame}{Exercise 5: Nonlinear Blending}
\begin{block}{Task}
...
\end{block}
\begin{itemize}
  \item File: \texttt{ex04\_blending/blending.py}
  \item Test: \texttt{python ex04\_blending/test\_blending.py}
\end{itemize}
\end{frame}
...
% Frame 17: Exercise 5
% ---------------------------------------------------------
\begin{frame}{Exercise 6: Set Cover}
\begin{block}{Task}
...
% Frame 19: Exercise 6
% ---------------------------------------------------------
\begin{frame}{Exercise 7: Knapsack}
\begin{block}{Task}
...
\begin{tikzpicture}[scale=0.85,
  vtx/.style={circle, draw, thick, fill=blue!15, minimum size=0.45cm,
              font=\scriptsize\bfseries},
  edge/.style={thick},
  tour/.style={very thick, red!70!black},
]
  % Cities
  \node[vtx] (0) at (1.5, 2.8) {0};
  \node[vtx] (1) at (0, 1.5)   {1};
  \node[vtx] (2) at (0.8, 0)   {2};
  \node[vtx] (3) at (2.2, 0)   {3};
  \node[vtx] (4) at (3.0, 1.5) {4};

  % Tour edges
  \draw[tour, -{Stealth}] (0) -- (1);
  \draw[tour, -{Stealth}] (1) -- (2);
  \draw[tour, -{Stealth}] (2) -- (3);
  \draw[tour, -{Stealth}] (3) -- (4);
  \draw[tour, -{Stealth}] (4) -- (0);

  % Position labels
  \node[font=\tiny, gray, above left=-2pt of 0] {$u{=}0$};
  \node[font=\tiny, gray, left=1pt of 1]  {$u{=}1$};
  \node[font=\tiny, gray, below=1pt of 2] {$u{=}2$};
  \node[font=\tiny, gray, below=1pt of 3] {$u{=}3$};
  \node[font=\tiny, gray, right=1pt of 4] {$u{=}4$};
\end{tikzpicture}
\end{center}
\end{column}
...
% ---------------------------------------------------------
\begin{frame}{Exercise 8: TSP (MTZ)}
\begin{block}{Task}
...
\end{block}
\begin{itemize}
  \item File: \texttt{ex11\_tsp\_mtz/tsp\_mtz.py}
  \item Test: \texttt{python ex11\_tsp\_mtz/test\_tsp\_mtz.py}
\end{itemize}
\end{frame}
...
% Frame 21: Exercise 7
% ---------------------------------------------------------
\begin{frame}{Exercise 8: Facility Location}
\begin{block}{Task}
...
% Frame 23: Exercise 8
% ---------------------------------------------------------
\begin{frame}{Exercise 9: Graph Coloring}
\begin{block}{Task}
...
% ---------------------------------------------------------
% Frame 24: Generator Scheduling Problem
% ---------------------------------------------------------
...
% ---------------------------------------------------------
\begin{frame}{Exercise 10: Indicator Constraints}
\begin{block}{Task}
...
% ---------------------------------------------------------
\begin{frame}{Exercise 12: Benchmarking Formulations}
...
\begin{itemize}
  ...
  \item Part 3: Column generation \& branch-and-price (bin packing)
\end{itemize}
\end{block}
\end{frame}
