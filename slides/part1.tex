...
\begin{center}
\begin{tikzpicture}
  % Set 1: large red horizontal ellipse at top
  \fill[red!25, fill opacity=0.6]
    (1.6, 2.5) ellipse (1.7 and 0.85);
  \draw[red!70!black, line width=1.2pt]
    (1.6, 2.5) ellipse (1.7 and 0.85);
  \node[font=\large\bfseries] at (2.1, 2.7) {1};

  % Set 2: blue tilted ellipse on left
  \fill[blue!20, fill opacity=0.5, rotate around={-65:(0.3,1.5)}]
    (0.3, 1.5) ellipse (0.65 and 1.5);
  \draw[blue!80!black, line width=1.2pt, rotate around={-65:(0.3,1.5)}]
    (0.3, 1.5) ellipse (0.65 and 1.5);
  \node[font=\large\bfseries] at (-0.1, 2.1) {2};

  % Set 3: green tilted ellipse on right
  \fill[green!15, fill opacity=0.5, rotate around={-25:(2.4,1.3)}]
    (2.4, 1.3) ellipse (0.6 and 1.1);
  \draw[green!50!black, line width=1.2pt, rotate around={-25:(2.4,1.3)}]
    (2.4, 1.3) ellipse (0.6 and 1.1);
  \node[font=\large\bfseries] at (2.7, 1.7) {3};

  % Set 4: purple small ellipse in center
  \fill[violet!30, fill opacity=0.5]
    (1.2, 0.6) ellipse (0.5 and 0.4);
  \draw[violet, line width=1.2pt]
    (1.2, 0.6) ellipse (0.5 and 0.4);
  \node[font=\large\bfseries] at (1.2, 0.6) {4};

  % Set 5: magenta vertical ellipse at bottom
  \fill[magenta!20, fill opacity=0.5]
    (1.4, -0.5) ellipse (0.75 and 1.2);
  \draw[magenta!70!black, line width=1.2pt]
    (1.4, -0.5) ellipse (0.75 and 1.2);
  \node[font=\large\bfseries] at (1.4, -1.0) {5};
\end{tikzpicture}
\end{center}
\vspace{-2pt}
