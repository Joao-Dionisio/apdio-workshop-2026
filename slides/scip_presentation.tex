...
\title{Let's SCIP it!}
\author{Author Name}
\titlegraphic{\includegraphics[width=3.5cm]{sciplogo.png}}
% \logo{\hspace{1mm}\includegraphics[width=1.8cm]{newscippy.png}}
\logo{\hspace{1mm}\includegraphics[width=1.8cm]{sciplogo.png}}
...
\sepframe[title={Branch-and-Price},image={\includegraphics[width=6cm]{scip-bap.png}}]
