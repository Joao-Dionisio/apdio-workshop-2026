...
\label{sec:org685dde7}

\begin{frame}[label={sec:orgdd3645c}]{Background}
\begin{itemize}
...
\begin{frame}[label={sec:org35b410f}]{The Pre-History: Joseph Fourier (1826)}
...
\begin{frame}[label={sec:org8dfa38b}]{Comparing "Projecting" vs. "Walking"}
\begin{itemize}
\item Fourier (1826):
\begin{itemize}
...
\begin{frame}[label={sec:org3303e3b}]{Visualizing the Two Approaches}
...
\begin{frame}[label={sec:orgebce716}]{Fourier's Method "Explodes"}
\begin{itemize}
...
\begin{frame}[label={sec:org44be166}]{The Stigler Diet Problem (1947)}
...
\begin{frame}[label={sec:org6ba3783}]{The Human "Computer": Jack Laderman's Achievement}
...
\begin{frame}[label={sec:org533eaf0}]{First Machine Implementations: SEAC and IBM 701}
...
\begin{frame}[label={sec:org952365c},fragile]{Before Modeling Languages: Physical Data Entry}
...
\begin{frame}[label={sec:org7e83220}]{Before Modeling Languages: Workflow}
\begin{enumerate}
...
\begin{frame}[label={sec:org7e3aa7a}]{The "Middle Ages": Matrix Generators}
...
\begin{frame}[label={sec:orgdfa703d},fragile]{The "Middle Ages"}
...
\begin{frame}[label={sec:org2164493},fragile]{The MPS Format (The Lingua Franca)}
...
\begin{frame}[label={sec:org58ec210},fragile]{MPS Format}
...
\begin{frame}[label={sec:orge7dba39},fragile]{The Representation Gap}
...
\begin{frame}[label={sec:orgd3548fd},fragile]{MPS: "Technical Debt" of the 1970s}
 \begin{itemize}
...
\label{sec:org4d2757f}

\begin{frame}[label={sec:org9ccacd4}]{Model Taxonomy: Choosing the Right Solver}
...
\label{sec:org38d6328}
\begin{frame}[label={sec:orgf3f2321},fragile]{The Renaissance: GAMS (1976)}
...
\begin{frame}[label={sec:orgfc7b1cb}]{The "good" modeling language checklist}
\begin{enumerate}
...
\begin{frame}[label={sec:orgf431b87},fragile]{Solver Independence}
 \begin{itemize}
...
\label{sec:org4f5438e}
\begin{frame}[label={sec:org252db80}]{Modern usage}
\begin{itemize}
...
\begin{frame}[label={sec:org8e4dfa5}]{}
...
\begin{frame}[label={sec:org0e75d4f},fragile]{Syntax Showdown: AMPL vs. Pyomo}
...
\begin{frame}[label={sec:org7d02d5e},fragile]{Modern Usage}
...
\begin{frame}[label={sec:orgcefa12a},fragile]{The Unified Syntax: amplpy}
...
\begin{frame}[label={sec:orgc828b98}]{Modern Tech Stack: A Modeler's Compass}
...
\begin{frame}[label={sec:org70236dc},fragile]{The Evolution of the Modeling Interface}
...
\begin{frame}[label={sec:orgf145a2d},fragile]{Advanced Topics: Column Generation}
...
\begin{frame}[label={sec:orgfabc502},fragile]{Advanced Topics: Cutting Planes}
...
\label{sec:org6594a4d}

\begin{frame}[label={sec:orgad785ea}]{Real-World Deployment: Beyond the Notebook}
...
\begin{frame}[label={sec:org0029e61},fragile]{Conclusion: From Alpha to Omega}
...
\begin{frame}[label={sec:org9ecc76a}]{Further Reading and References: The "Alpha" (Foundational Papers)}
\begin{itemize}
...
\begin{frame}[label={sec:org0c4ea3e}]{Further Reading and References: The "Middle Ages" and "Renaissance"}
\begin{itemize}
...
\begin{frame}[label={sec:org109619f},fragile]{The "Omega": Modern APIs and Libraries}
 \begin{itemize}
